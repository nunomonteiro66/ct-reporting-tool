...
export type TSelectionOfProduct = {
  ...
  productSelection?: Maybe<TProductSelection>;
  productSelectionRef: TReference;
  variantSelection: TProductVariantSelectionIncludeOnly;
};

export type TProductVariantSelectionIncludeOnly = {
  _typename?: 'ProductVariantSelectionIncludeOnly';
  skus?: InputMaybe<Array<Scalars['String']>>;
};
